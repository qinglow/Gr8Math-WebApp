            ...
            <div className="flex flex-col gap-y-3 px-6 pt-6 flex-1">
                {tabs.map((tab) => (
                    <button 
                        ...
                        className={`flex items-center gap-x-4 px-5 py-3.5 rounded-xl font-bold transition-all border outline-none ${activeTab === tab.id ? 'bg-[#EFBD31]/10 border-[#EFBD31]/30 text-[#EFBD31] shadow-sm' : 'bg-transparent border-transparent text-[#0F8B8D] hover:bg-[#D1D8DD]/50'}`}
                    >
